...
-- FISH_INFO 테이블의 구조는 다음과 같으며 ID, FISH_TYPE, LENGTH, 
-- TIME은 각각 잡은 물고기의 ID, 물고기의 종류(숫자), 잡은 물고기의 길이(cm), 
-- 물고기를 잡은 날짜를 나타냅니다.
-- # 단, 잡은 물고기의 길이가 10cm 이하일 경우에는 LENGTH 가 NULL 이며, 
-- LENGTH 에 NULL 만 있는 경우는 없습니다.

-- # FISH_NAME_INFO 테이블은 물고기의 이름에 대한 정보를 담고 있습니다. 
-- FISH_NAME_INFO 테이블의 구조는 다음과 같으며, FISH_TYPE, FISH_NAME은 
-- 각각 물고기의 종류(숫자), 물고기의 이름(문자) 입니다.
-- # 문제
